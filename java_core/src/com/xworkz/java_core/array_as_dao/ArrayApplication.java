package com.xworkz.java_core.array_as_dao;

import com.xworkz.java_core.array_as_dao.dto.StudentDTO;
import com.xworkz.java_core.array_as_dao.services.StudentService;
import com.xworkz.java_core.array_as_dao.services.StudentServiceImpl;
...
public class ArrayApplication {
	...
	//	StudentDTO dto1 = new StudentDTO("2","Hanmanth","BTM02",9740884217l,"75%");
		//StudentDTO dto2 = new StudentDTO("3","sharan","BTM03",9740884232l,"67%");
